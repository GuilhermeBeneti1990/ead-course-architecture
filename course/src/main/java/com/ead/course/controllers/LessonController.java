...
public class LessonController {
    ...
    public ResponseEntity<Object> updateLesson(
        ...
        lessonModel.setTitle(lessonModel.getTitle());
        lessonModel.setDescription(lessonModel.getDescription());
        lessonModel.setVideoUrl(lessonModel.getVideoUrl());
    ...
    public ResponseEntity<Object> findById(@PathVariable("moduleId")UUID moduleId,
                                           @PathVariable("lessonId")UUID lessonId) {
        Optional<LessonModel> lessonModelOptional = lessonService.findLessonIntoModule(moduleId, lessonId);
